  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-background text-foreground px-4 py-8">
      ...
      <div className="pointer-events-none absolute inset-0 select-none">
        ...
        <div className="absolute -left-16 top-24 h-72 w-72 border-2 border-foreground/20" />
        <div className="absolute -right-20 bottom-16 h-80 w-80 border-2 border-foreground/10" />
      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100vh-4rem)] w-full max-w-7xl flex-col">
        ...
        <div className="grid flex-1 items-center gap-12 py-12 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <section className="border-2 border-foreground bg-background p-8">
            <div className="mb-8">
              <p className="font-mono text-xs uppercase tracking-[0.2em] text-muted-foreground">Login</p>
              <h2 className="mt-2 font-serif text-3xl font-bold uppercase tracking-tighter text-foreground">Sign In</h2>
            </div>
            ...
            <p className="mt-6 text-center font-serif text-muted-foreground">
              ...
              <Link href="/register" className="font-mono text-xs uppercase tracking-widest text-foreground underline transition-colors duration-100 hover:text-muted-foreground">
                Sign up
              </Link>
            </p>
          </section>
